...
- Container auto-restart on Windows Docker Desktop startup (changed restart policy from `unless-stopped` to `always`)
...
[1.1.1]: https://github.com/rommelporras/claude-code-monitoring/releases/tag/v1.1.1
